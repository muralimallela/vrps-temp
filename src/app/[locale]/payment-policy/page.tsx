...
export async function generateMetadata({
  ...
  const data = isTelugu ? SEO_PAGE_DATA.paymentPolicy.te : SEO_PAGE_DATA.paymentPolicy.en;
    ...
    <div className="min-h-screen bg-[#FFFDF9] py-12 px-4 sm:px-6 lg:px-8 text-[#2B0904]">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: isTelugu ? "చెల్లింపుల విధానం" : "Payment Policy", url: `/${locale}/payment-policy` },
        ]}
      />
