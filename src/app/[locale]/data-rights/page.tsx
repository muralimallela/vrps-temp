  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_#fff8ef,_#fdeed8_35%,_#f4d8b0_100%)] px-4 py-8 md:px-8 md:py-12 text-[#2B0904]">
      <div className="mx-auto max-w-4xl">
        {/* Banner */}
        <div className="mb-8 rounded-3xl border border-[#e4c69d] bg-white p-6 shadow-xl md:p-8">
          ...
          <h1 className="text-3xl font-black text-[#3d120d] md:text-4xl">
            Data Principal Rights & Grievance Portal
          </h1>
          <p className="mt-2 text-sm leading-relaxed text-[#5a3a2e] md:text-base">
            Under the <strong>Digital Personal Data Protection (DPDP) Act, 2023</strong>, you have full authority to request access to, correction of, or erasure of your personal data, or nominate a representative and lodge grievances.
          </p>
          ...
          <div className="rounded-3xl border border-[#e4c69d] bg-white p-6 shadow-xl md:p-10">
            {submittedResult ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Conditional Fields for Correction */}
                ...
                {/* Conditional Fields for Nomination */}
                {requestType === "nomination" && (
                ...
                {/* Statutory Consent & Duties Notice */}
