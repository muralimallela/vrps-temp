...
const AssemblySiegePage: React.FC = () => {
  const t = useTranslations("AssemblySiege");

  return (
    <div className="bg-[#FFFDF9] text-gray-900 min-h-screen pb-20">
      {/* ======= Hero Section ======= */}
      <section className="relative overflow-hidden bg-gradient-to-b from-[#36100B] via-[#4A120A] to-[#6A160A] py-16 md:py-24 text-white text-center shadow-lg">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 sm:mt-16 space-y-16">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#6A160A] text-center mb-6">
          {t("title")}
        </h2>
        <p className="text-center text-gray-700 max-w-3xl mx-auto text-base sm:text-lg font-medium leading-relaxed mb-12">
          {t("subtitle")}
        </p>
...
export default AssemblySiegePage;
