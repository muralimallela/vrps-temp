...
export default function DonationsClient({ isTelugu = false }: { isTelugu?: boolean }) {
      ...
      <section className="mx-auto max-w-6xl">
        ...
        <header className="mb-8 rounded-2xl border border-[#e4c69d] bg-white/85 p-6 shadow-[0_20px_40px_-24px_rgba(90,28,22,0.45)] backdrop-blur md:p-8">
          <p className="mb-2 inline-block rounded-full bg-[#6A160A] px-3 py-1 text-xs font-semibold uppercase tracking-wider text-white">
            {isTelugu ? "VRPS సంక్షేమ నిధి" : "Support VRPS"}
          </p>
          <h1 className="text-3xl font-black leading-tight text-[#3d120d] md:text-4xl">
            {isTelugu ? "సమాజ సేవలో మీ వంతు భాగస్వామ్యం" : "Help Turn Community Support Into Action"}
          </h1>
          <p className="mt-3 max-w-3xl text-sm leading-relaxed text-[#5a3a2e] md:text-base">
            {isTelugu
              ? "విద్యార్థుల ఉపకార వేతనాలు, సమాజ అవగాహన సదస్సులు మరియు సంక్షేమ కార్యక్రమాలకు మీ స్వచ్ఛంద సహకారం అందించండి."
              : "Every contribution helps expand awareness, outreach, and community programs. Giving is always optional and is separate from VRPS membership."}
          </p>
