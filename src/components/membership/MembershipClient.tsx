...
export default function MembershipClient({ isTelugu = false }: { isTelugu?: boolean }) {
      ...
      <section className="mx-auto max-w-6xl">
        <header className="mb-8 rounded-2xl border border-[#e4c69d] bg-white/85 p-6 shadow-[0_20px_40px_-24px_rgba(90,28,22,0.45)] backdrop-blur md:p-8">
          <p className="mb-2 inline-block rounded-full bg-[#6A160A] px-3 py-1 text-xs font-semibold uppercase tracking-wider text-white">
            {isTelugu ? "సభ్యత్వ నమోదు" : "Join VRPS"}
          </p>
          <h1 className="text-3xl font-black leading-tight text-[#3d120d] md:text-4xl">
            {isTelugu ? "సభ్యత్వం పొందండి — ఉద్యమాన్ని బలోపేతం చేయండి" : "Become a Member. Strengthen the Movement."}
          </h1>
          <p className="mt-3 max-w-3xl text-sm leading-relaxed text-[#5a3a2e] md:text-base">
            {isTelugu
              ? "సమాజ ప్రగతి, విద్యా వికాసం మరియు హక్కుల సాధనకు తోడ్పడండి. అధికారిక డిజిటల్ గుర్తింపు కార్డు అందుకోండి."
              : "Join a community working for representation, opportunity, and progress. Membership starts at Rs. 99 and gives you a verified digital Member ID Card."}
          </p>
        ...
        <div className="grid gap-6 lg:grid-cols-5">
          <aside className="rounded-2xl border border-[#e4c69d] bg-white p-5 shadow-sm lg:col-span-2">
            ...
            <p className="mt-1 text-sm text-[#6a4a3b]">
              Membership starts at Rs. 99. A higher amount helps support community programs.
            </p>
          ...
          <div className="rounded-2xl border border-[#e7d1ba] bg-white p-5 shadow-sm lg:col-span-3">
            ...
            <div className="mt-4 rounded-lg border border-[#eddcc8] bg-[#fffaf4] p-4 text-sm text-[#5a3a2e]">
              ...
              <p className="mt-3 border-t border-[#eddcc8] pt-3 text-xs text-[#6a4a3b]">
                <strong>Note:</strong> Activation usually happens within a few seconds after confirmation.
              </p>
            </div>
            ...
            {/* DPDP Act 2023 Explicit Consent Section */}
            ...
            <button
              ...
              disabled={loading}
              className="mt-6 w-full rounded-lg bg-[#6A160A] px-4 py-3 text-sm font-bold text-white transition hover:bg-[#561007] disabled:cursor-not-allowed disabled:opacity-70 shadow-sm"
            >
