...
export default function ExecutiveCommitteeClient({
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF9] text-slate-900 pb-20">
      {/* Hero Section */}
      <header className="relative overflow-hidden bg-gradient-to-b from-[#36100B] via-[#4A120A] to-[#6A160A] py-16 md:py-24 text-white">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 -mt-10 relative z-10">
              ...
              >
                ...
                <div className="relative h-72 w-full overflow-hidden rounded-2xl bg-slate-100 mb-5 shadow-inner">
                  <Image
                    ...
                    alt={`${member.name} - ${member.designation}, VRPS`}
                    fill
